...
Run the following cells in the deployment notebook (`lab-3-reinforcement-learning-from-verifiable-rewards/4-deployment.ipynb`) to delete the endpoint resources:
