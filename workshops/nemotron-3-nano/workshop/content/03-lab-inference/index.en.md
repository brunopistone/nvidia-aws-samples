...
In this lab, you will deploy the model you fine-tuned in [Lab 1](/02-lab-sft/) and run inference against it on a **SageMaker AI real-time endpoint**.
...
3. **Clean up resources** - Tear down endpoints to avoid ongoing charges
